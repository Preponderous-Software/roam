...
|------|---------|---------|
<<<<<<< HEAD
| 2026-08-02 | 1 | feat: Read-only REST API for external client tools (#231) — an opt-in, stdlib-only `http.server` embedded in the Roam process exposing `/api/v1/world`, `/rooms`, `/rooms/{x}/{y}`, `/player`, `/entities` as read-only JSON, gated behind `restEnabled`/`restPort` config |
=======
...
>>>>>>> 8ec87cda83f29ba55401040b17ad9bc4ddc889e0
