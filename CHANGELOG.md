...
|------|---------|---------|
| 2026-07-25 | 1 | chore: merge origin/main into PR #518 to resolve conflicts — merged the latest `main`, kept the corrupt-map-image startup recovery plus web cache/versioning fixes, and accepted main's existing browser-save sync implementation/tests where the changes overlapped. Targeted `pytest` + `black --check` revalidated the resolved files |
