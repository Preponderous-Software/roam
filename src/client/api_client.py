...
class RoamAPIClient:
    ...
    def _refresh_access_token(self) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "POST", "/api/v1/auth/refresh", json={"refreshToken": self.refresh_token}
        )
    ...
    def perform_player_action(
        ...
        return self._make_request(
            "POST", f"/api/v1/session/{sid}/player/action", json=payload
        )

    def update_player_energy(
        self, amount: float, operation: str = "add", session_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def select_inventory_slot(
        self, slot_index: int, session_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def swap_inventory_slots(
        self, from_slot: int, to_slot: int, session_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_room(
        self, room_x: int, room_y: int, session_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        return self._make_request(
            "GET", f"/api/v1/session/{sid}/room/{room_x}/{room_y}"
        )
