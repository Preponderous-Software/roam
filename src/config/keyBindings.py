...
class KeyBindings:
    ...
    DEFAULT_BINDINGS = {
        ...
        "hotbar_cycle_left": KeyCode.LEFTBRACKET,
        "hotbar_cycle_right": KeyCode.RIGHTBRACKET,
        "gather": KeyCode.G,
        "place": KeyCode.F,
        "toggle_minimap": KeyCode.M,
        "minimap_zoom_in": KeyCode.EQUALS,
        "minimap_zoom_out": KeyCode.MINUS,
        "minimap_level_up": KeyCode.PAGEUP,
        "alt_minimap_level_up": KeyCode.COMMA,
        "minimap_level_down": KeyCode.PAGEDOWN,
        "alt_minimap_level_down": KeyCode.PERIOD,
        "minimap_level_reset": KeyCode.HOME,
        "alt_minimap_level_reset": KeyCode.SLASH,
        "screenshot": KeyCode.PRINTSCREEN,
        "alt_screenshot": KeyCode.P,
    ...
    ACTION_LABELS = {
        ...
        "hotbar_9": "Hotbar 9",
        "hotbar_0": "Hotbar 0",
        "hotbar_cycle_left": "Hotbar Cycle Left",
        "hotbar_cycle_right": "Hotbar Cycle Right",
        "gather": "Gather",
        "place": "Interact / Place",
        "toggle_minimap": "Toggle Minimap",
        "minimap_zoom_in": "Minimap Zoom In",
        "minimap_zoom_out": "Minimap Zoom Out",
        "minimap_level_up": "Minimap Level Up",
        "alt_minimap_level_up": "Minimap Level Up (Alt)",
        "minimap_level_down": "Minimap Level Down",
        "alt_minimap_level_down": "Minimap Level Down (Alt)",
        "minimap_level_reset": "Minimap Back To My Level",
        "alt_minimap_level_reset": "Minimap Back To My Level (Alt)",
        "screenshot": "Screenshot",
        "alt_screenshot": "Screenshot (Alt)",
